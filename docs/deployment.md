...
| `MPT_DATABASE_URL` | - | `postgresql://postgres:postgres@postgres:5432/usage_reporting` | PostgreSQL connection string reserved for the upcoming PostgreSQL store; unused at runtime today |
